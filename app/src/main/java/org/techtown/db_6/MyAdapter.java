...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof MealCardViewHolder) {
            ...
            ((MealCardViewHolder) viewHolder).minus2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                   // AlertDialog.Builder builder = new AlertDialog.Builder(view.getContext());
                    //AlertDialog dialog = builder.setMessage("삭제하시겠습니까?").setPositiveButton("확인", null).create();
                    //dialog.show();
                    ...
                    notifyItemRangeChanged(position, myDataList.size());
                    {
                        ...
                        //인터페이스 객체구현
                        Call<UserCard> call = service1.deleteUserCard("8010043000786344");
                        //사용할 메소드 선언
    ...
    public class EduCardViewHolder extends RecyclerView.ViewHolder {
        ...
        EduCardViewHolder(View itemView) {
            super(itemView);
            minus3 = itemView.findViewById(R.id.minus3);
            content = itemView.findViewById(R.id.content);
            name = itemView.findViewById(R.id.tv);
            image = itemView.findViewById(R.id.imageView);
            button = itemView.findViewById(R.id.button);
